				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Add Syallabus</h3>
						...
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-sm-6">
									<form action="SyllabusFiles.php" enctype="multipart/form-data" method="POST">
								<select  ng-model="subname" class="form-control input-lg">{{subjects}}
									 	<option ng-repeat="s in subjects" value="{{s.subid}}"> {{s.subname}}
									 	</option>
										
									</select>
									<br>
									<input type="file" name="fileToUpload" id="fileToUpload" class="form-control input-lg" placeholder="File Name">
									<!-- <input type="file" class="form-control input-lg" placeholder="File Name">
									<br> -->
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Syallabus List</h3>
								</div>
								<div class="panel-body">
									<!-- <div class="row">
										<div class="col-sm-6"> -->
